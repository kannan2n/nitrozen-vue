<template>
  <div id="app">
    <div class="main-div">
      <nitrozen-input :autofocus="autofocusSearch" v-model="inputModel" @input="getState" :required="true" :label="'Name'"
        :helperText="'Enter full name'" :placeholder="'Enter Name'"></nitrozen-input>
    </div>
  </div>
</template>
